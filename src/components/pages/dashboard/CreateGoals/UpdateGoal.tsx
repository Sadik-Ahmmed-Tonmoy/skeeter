...
export default function UpdateGoal() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    if (data.image && data.image instanceof File) {
      formDataPayload.append("goalImage", data.image);
    }
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                {/* Image Upload */}
                <div>
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-16 text-center hover:border-gray-400 transition-colors relative">
                    {formData.image ? (
                      <div className="text-sm text-gray-600">
                        ...
                        {/* <p className="font-medium">{typeof formData.image !== "string" && formData.image?.name}</p> */}
